...
public class PhotoViewActivity extends BaseActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener{
            ...
            if (data != null && requestCode == REQUEST_CODE_SELECT) {
                ...
                if (images != null) {
                    ...
                    new Thread(){//创建一个新的线程
                        public void run(){
                            try {
                                FilesCopyUtils.PicCopy(getApplicationContext(),selImageList);
